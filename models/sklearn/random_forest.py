...
class RandomForestModel(BaseModel):
    ...
    def __init__(self):
        super().__init__(name="Random Forest", framework="sklearn")
        self._task = None
        self._build_kwargs = {}
    ...
    def build(self, task: str = 'classification', **kwargs) -> None:
        ...
        if task == 'classification':
            self.model = RandomForestClassifier(**self._build_kwargs)
        else:
            self.model = RandomForestRegressor(**self._build_kwargs)
