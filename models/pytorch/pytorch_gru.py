...
class PytorchGRUModel(BaseModel):

    def __init__(self):
        super().__init__(name="PyTorch GRU", framework="pytorch")
        self._build_config = {}
    ...
    def build(self, input_dim: int = None, output_dim: int = None, **kwargs) -> None:
        ...
        self.model = _GRUNetwork(input_dim, output_dim, hidden_units)
